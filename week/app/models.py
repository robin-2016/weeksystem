...
#	task = db.Column(db.String(200))
	...
	worktime0 = db.Column(db.Float)
	completed0 = db.Column(db.SmallInteger)
	something1 = db.Column(db.Text)
	worktime1 = db.Column(db.Float)
	completed1 = db.Column(db.SmallInteger)
	something2 = db.Column(db.Text)
	worktime2 = db.Column(db.Float)
	completed2 = db.Column(db.SmallInteger)
	something3 = db.Column(db.Text)
	worktime3 = db.Column(db.Float)
	completed3 = db.Column(db.SmallInteger)
	more0 = db.Column(db.Text)
	more1 = db.Column(db.Float)
	more2 = db.Column(db.SmallInteger)
